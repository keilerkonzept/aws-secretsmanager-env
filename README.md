...
```bash
# Linux
curl -L https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.87/aws-secretsmanager-env_1.1.87_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.87/aws-secretsmanager-env_1.1.87_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.87/aws-secretsmanager-env_1.1.87_windows_x86_64.zip
unzip aws-secretsmanager-env_1.1.87_windows_x86_64.zip
```
