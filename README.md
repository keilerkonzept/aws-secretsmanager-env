...
```bash
# Linux
curl -L https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.107/aws-secretsmanager-env_1.1.107_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.107/aws-secretsmanager-env_1.1.107_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/keilerkonzept/aws-secretsmanager-env/releases/download/1.1.107/aws-secretsmanager-env_1.1.107_windows_x86_64.zip
unzip aws-secretsmanager-env_1.1.107_windows_x86_64.zip
```
